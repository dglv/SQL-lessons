...
insert into product(model, manufacturer) values ("iPhone5", "Apple");
insert into product(model, manufacturer) values ("iPhone5s", "Apple");
insert into product(model, manufacturer) values ("iPhone7", "Apple");
...
insert into product(model, manufacturer) values ("Samsung Galaxy","Samsung");
...
insert into phone(model, ram_size, hdd_size, screen_size, price) values ("iPhone5s", 256, 8.6, 14, 333.5);
insert into phone(model, ram_size, hdd_size, screen_size, price) values ("iPhone5", 512, 16, 17, 508.2);
insert into phone(model, ram_size, hdd_size, screen_size, price) values ("iPhone7", 1024, 32.3, 20, 612);
insert into phone(model, ram_size, hdd_size, screen_size, price) values ("Samsung Galaxy", 1024, 32.1, 20, 515.7);
